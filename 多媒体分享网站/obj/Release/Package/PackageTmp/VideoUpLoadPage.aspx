...
=======
 ...
 return;
	    ...
	    option.formData = { 'video_title': document.getElementById('TextBox1').value, 'video_des': document.getElementById('TextBox2').value, 'user_id': '<%=(Session["user"] as 多媒体分享网站.Model.UserModel).id%>' };
>>>>>>> 144a6a2ec78c345fe6dccee65c21c406da0dc7c7
		up.upload('*');
	});
	});
</script>
